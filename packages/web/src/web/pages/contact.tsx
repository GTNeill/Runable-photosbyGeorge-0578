...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]" style={{ paddingTop: "var(--nav-height)" }}>
      {/* Header */}
      <div className="pt-8 sm:pt-12 pb-10 sm:pb-14 px-4 sm:px-6 max-w-[2560px] mx-auto">
      ...
      {/* Contact details */}
      <div className="px-4 sm:px-6 max-w-[2560px] mx-auto pb-24">
        {fields.length === 0 ? (
      ...
      <footer className="border-t border-[#2A2A2A] py-10 sm:py-12">
        <div className="max-w-[2560px] mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
